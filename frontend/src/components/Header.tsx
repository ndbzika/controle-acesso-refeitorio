...
export const Header = () => {
  ...
  return (
    <header className="w-full h-16 md:h-28 bg-green flex justify-between items-center px-20">
      {isLoggedIn() && (<Link to='/admin/dashboard'>
        <HomeIcon size="64" className="text-white cursor-pointer" />
      </Link>)}
      <h1 className="text-3xl md:text-5xl text-center w-full text-white">Refeitorio</h1>
